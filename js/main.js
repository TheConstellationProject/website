...
(function($) {
    ...
    if (mailchimpForm.length) {
        mailchimpForm.ajaxChimp({
            ...
            url: "h" // Replace this with your own mailchimp post URL. Paste the url inside "". The mailchimp post url will look like this: http://blahblah.us1.list-manage.com/subscribe/post?u=5afsdhfuhdsiufdba6f8802&id=4djhfdsh99f
        });
    }
